...
//1716 1717 1719 1729 
	...
	public void IDA4_1732_StartVisitNote() throws Throwable {
		...
		awaitPriortyInProgress.VerifyIfUserCanTypeInNoOfDaysAndCharactersOrSplCharactersInTheTextbox(prop.getProperty("NoOfdaysValue"));
	}
	...
	public void IDA4_1735_StartVisitNote() {

			awaitPriortyInProgress.clickOnPatientName(prop.getProperty("awaiting.visit.id"));
			visitSummaryPage.clickOnStartVisitNoteButton();
	...
	@Severity(SeverityLevel.NORMAL)
	public void IDA4_1736_StartVisitNote() {
			awaitPriortyInProgress.clickOnPatientName(prop.getProperty("awaiting.visit.id"));
			visitSummaryPage.clickOnStartVisitNoteButton();
	...
	public void IDA4_1740_StartVisitNote() throws Throwable {
		awaitPriortyInProgress
				.VerifyUserIsAbleToEnterTextInAdditionalInstructionsTextAreaUnderMedicationSection();
	}
	...
	public void IDA4_1742_StartVisitNote() throws Throwable {
		...
		awaitPriortyInProgress.VerifyAdditionalInstructionswithMultipleLines(prop.getProperty("AdditionalInstructionsText1"),prop.getProperty("AdditionalInstructionsText2"));
	}
	...
	public void IDA4_1749_StartVisitNote() throws Throwable {
		...
		awaitPriortyInProgress.VerifyAddMultipleAdvice(prop.getProperty("AdditionalInstructionsText1"),prop.getProperty("AdditionalInstructionsText2"));
	}
	...
	public void IDA4_1752_StartVisitNote() throws Exception {
			...
			awaitPriortyInProgress.setTestName(prop.getProperty("test.name"));
			Assert.assertTrue(awaitPriortyInProgress.isDisplayedTestsList(prop.getProperty("Testdata2")));
			awaitPriortyInProgress.clickOnDashboard();
	}
	...
	public void IDA4_1753_StartVisitNote() throws Exception {
			...
			String testName = prop.getProperty("test.name");
	...
	public void IDA4_1754_StartVisitNote() throws Exception {
			...
			Assert.assertEquals(awaitPriortyInProgress.getTextOfTest(), prop.getProperty("Testdata1"));
			awaitPriortyInProgress.setTestName(prop.getProperty("Testdata2"));
			awaitPriortyInProgress.clickOnTestName(prop.getProperty("test.name"));
			awaitPriortyInProgress.clickOnButtons("btnSubmitTest");
	...
	public void IDA4_1755_StartVisitNote() throws Throwable {
		...
		awaitPriortyInProgress.verifyDelFnctninVisitSumPage(prop.getProperty("Testdata1"));
	}
