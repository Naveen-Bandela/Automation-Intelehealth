...
public class ChangePasswordLanguagePage extends BasePage {
	...
	By DashboardMenu = By.xpath("//a[@data-test-id='linkDashboard']");
	By HamburgerMenu = By.xpath("//button[@data-test-id='btnProfileDropdown']");//a[@data-test-id="linkDashboard"]
	By ChangePasswordOption = By.xpath("//button[@data-test-id='btnChangePasswordMain']");
	By ChangeLanguageOption = By.xpath("//button[@data-test-id='btnSelectLanguageMain']");
	By ChangePasswordOldPWTextbox = By.xpath("//input[@data-test-id='etOldPass']");
	By ChangePasswordNewPWTextbox = By.xpath("//input[@data-test-id='etNewPass']");
	By ChangePasswordConfirmPWTextbox = By.xpath("//input[@data-test-id='etConfirmPass']");
	By ChangePasswordButton = By.xpath("//button[@data-test-id='btnSubmit']");
	By GeneratePasswordLink = By.xpath("//a[@data-test-id='linkGeneratePass']");
	By ChangePasswordSuccessPopup = By.xpath("//div[text()=' Password has been changed successfully! ']");
	By LogoutLink = By.xpath("//a[@data-test-id='linkLogout']");
	By LogoutConfirmYes = By.xpath("//button[@data-test-id='btnSubmit']");
	...
	By SelectEnglishLanguage = By.xpath("//input[@data-test-id='radioEnglish']");
	By SelectRussianLanguage = By.xpath("//input[@data-test-id='radioRussian']");
	By SelectButton = By.xpath("//button[@data-test-id='btnSubmit']");
	...
	public void VerifyLoginNewPassword(String username, String password) throws InterruptedException {
		...
		extentReport.logToExtentReport("Entered Password");
