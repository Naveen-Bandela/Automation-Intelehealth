...
public class CalendarPage extends BasePage {
	...
	By setupCalendar = By.xpath("//h6[text()='Setup your calendar']");
	...
	By dataMonth = By.xpath("(//mat-icon[text()='keyboard_arrow_right'])[1]");
	...
	By moreTimingsMonth = By.xpath("((//li[@class='list-item ng-star-inserted'])[6]");
	By moreTimings = By.xpath("//a[@data-test-id='linkAddMoreTiming']");
	...
	By selectStartTime = By.xpath("(//div[@role='option'])[1]");
	By startTimeAmPm = By.xpath("//ng-select[@data-test-id='selStartAm&Pm']");
	By selectStartTimeAm = By.xpath("//span[@data-test-id='startAmPm0']");
	By endTime = By.xpath("//ng-select[@data-test-id='selEndTime']");
	By selectEndTime = By.xpath("(//div[@aria-selected='false'])[1]");
	By endTimeAmPm = By.xpath("//ng-select[@data-test-id='selEndAm&Pm']");
	By selectEndTimePm = By.xpath("//span[@data-test-id='endAmPm1']");
	By selectDay = By.xpath("//ng-select[@data-test-id='selDays']");
	By selectTheDay = By.xpath("//input[contains(@data-test-id,'dayOptionIp')]");
	By saveSlot = By.xpath("//button[@data-test-id='btnSaveSlot']");
	By deleteButton = By.xpath("//button[@data-test-id='btnDeleteSlot0']");
	By deleteButtons = By.xpath("//button[contains(@data-test-id,'btnDeleteSlot')]");
	By confirmPopup = By.xpath("//div[@class='modal-con mt-4']");
	By confirmText = By.xpath("//h6[text()='Confirm']");
	By popupText = By.xpath("//p[text()='Do you really want to delete this timing slot?']");
	By confirmButton = By.xpath("//button[@data-test-id='btnSubmit']");
	By cancelButton = By.xpath("//button[@data-test-id='btnCancel']");
	...
	By daysoffSaved = By.xpath("//h6[@data-test-id='labelYourDaysOff']/..//div[@class='chip-item ng-star-inserted']");
	By firstSavedDayOff = By
			.xpath("(//h6[@data-test-id='labelYourDaysOff']/..//div[@class='chip-item ng-star-inserted'])[1]");
	By secondSavedDayOff = By
			.xpath("(//h6[@data-test-id='labelYourDaysOff']/..//div[@class='chip-item ng-star-inserted'])[2]");
	By clickBody = By.xpath("(//div[@class='card-body'])[1]");
	By removeDaysoff = By.xpath("(//mat-icon[text()='close'])[last()]");
	By removeAllDaysoff = By.xpath("//mat-icon[text()='close']");
	...
	By latestDaysoffSaved = By.xpath("(//div[@class='chip-item ng-star-inserted'])[last]");
	By monthlyTab = By.xpath("(//div[@role='tab'])[3]");
	...
	By yourCalendarTitle = By.xpath("//h6[text()='Your calendar']");
	By manageCalendarButton = By.xpath("//button[@data-test-id='btnManageCal']");
	By dateDayYearCalendar = By.xpath("//h6[@data-test-id='labelCalendarDate']");
	By weeklyTab = By.xpath("(//div[@role='tab'])[2]");
	...
	By weeklyCalendarAppointmentText = By.xpath("//h6[text()='Appointment']");
	By weeklyCalendarPatientNameandAge = By.xpath("//div[@class='patient-con']//h6");
	By weeklyCalendarBookedByNurse = By.xpath("(//div[@class='info-row'])[4]//div[text()='Booked by']/..");
	By bookedBy = By.xpath("//div[text()='Booked by']");
	By weeklyCalendarBookedByWithNurseName = By
			.xpath("(//div[@class='info-row'])[4]//..//div[@class='info-con ng-star-inserted']");
	By weeklyCalendarCurrentTimeGreenLine = By.xpath("//div[@class='cal-current-time-marker ng-star-inserted']");
	By weeklyCalendarViewDetailsLink = By.xpath("//a[text()='View details']");
	By weeklyCalendarPatientId = By.xpath("//p[@class='mb-0']/..//p[contains(text(),'PID :')]");
	By weeklyCalendarStatus = By.xpath("//div[@class='priority-tag']");
	By weeklyCalendarAppointmentOn = By.xpath("//div[@class='info-row']//div[text()='Appointment on']/..");
	By weeklyCalendarAppointmentBookedOn = By.xpath("//div[@class='info-row']//div[text()='Booked on']/..");
	By weeklyCalendarChiefComplaint = By.xpath("//div[@class='info-row']//div[text()='Chief Complaint']/..");
	By weeklyCalendarAppointmentProvidePrescriptionButton = By.xpath("//button[@data-test-id='btnProvideAppDetail']");
	By weeklyCalendarAppointmentFollowUpCallIcon = By.xpath("//div[text()='Booked by']/..//img[@class='ml-2']");
	By weeklyCalendarFollowUpVisitPrescriptionCreated = By.xpath("//div[contains(text(),' Prescription created')]");
	...
	By weeklyCalendarAppointmentorFollowUpVisitStatusCompleted = By.xpath("//div[text()=' Completed ']");
	...
	By closeButton = By.xpath("//img[@data-test-id='btnCloseAppDetail']");
	...
	By monthlyCalendarAppointment = By
			.xpath("//div[@data-test-id='mwlCalMonthView']//..//div[contains(text(),'Appointment')]");
	By monthlyFollowUp = By.xpath("//div[@data-test-id='mwlCalMonthView']//..//div[contains(text(),'Follow-up')]");
	By monthlyCalendarDates = By.xpath("//span[@class='cal-day-number-con']");
	...
	By monthlyCalendarPopUpDate = By.xpath("(//h6[@class='mb-0'])[2]");
	By monthlyCalendarPopUpAppointment = By.xpath("//div[@class='info-row']//div[contains(text(),'Appointments (')]");
	By monthlyCalendarPopUpFollowUps = By.xpath("//div[@class='info-row']//div[contains(text(),'Follow-ups (')]");
	By monthlyCalendarPopUpMarkAs = By.xpath("//div[@class='form-group row']//label[@for='markAS']");
	...
	By markAsHoursOffPopUp = By.xpath("//div[@class='intel-con-modal']");
	...
	By monthlyCalendarToday = By.xpath("//mwl-calendar-month-cell[contains(@class,'today')]");
	By closeButtonDayOff = By.xpath("//mat-icon[text()='close']");
	By markAsDayOffText = By.xpath("//h6[text()='Mark as day off']");
	...
	By selectedMonth = By.cssSelector("[data-test-id='labelSelectedMonth']");
...
//			String typeOfVisit = elementActions.doGetText(calenadrPopupTypeOfVisitTitle);
	 ...
	 */
	@Step("Appointment and Follow-up visit displayed in weekly calendar")
	public void VerifyThatAppointmentListDisplayInTimeSlot()
			throws Throwable, ElementClickInterceptedException {
		extentReport.logToExtentReport("Clicking on view calendar");
		elementActions.waitForElementClickable(viewCalendar);
		Thread.sleep(2000);
...
//			String typeOfVisit = elementActions.doGetText(calenadrPopupTypeOfVisitTitle);
	...
	@Step("Verify that user can able to view the 'Completed' Appointment details popup")
	public void UserAbleToViewTheCompletedAppointmentDetailsPopup()
			throws Throwable, ElementClickInterceptedException {
	...
	public void AppointmentStatusPrescriptionCreatedMessageNurseNameDisplayingCorrectlyOnAppointmentDetailsPopup()
		...
		fail("Verification failed - Required elements not found in the appointment details popup");
	}
...
//		Thread.sleep(2000);
	...
	public void VerifyAppointmentAndFollowUpDetailsPopupPageforInprogressOrAwaitingVisitPatient()
		...
		/*Commented because for one visit it is not possible to have all 4 status.. Need to revamp this block
		 * 
