...
public class ProfilePage extends BasePage {
	...
	By SelectSignature = By.xpath("//span[@class='ng-arrow-wrapper']");
	By Signature1 = By.xpath("(//div[@role='option'])[1]");
	By ProfilePictureUploadIcon = By.className("file-input-con");
