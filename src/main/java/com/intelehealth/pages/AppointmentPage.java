...
//					break;
				...
				if (ReschedulePopUp == true) {
					...
					// System.out.println("Reschedule PopUp is displayed");
					break;
				}
...
//			// System.out.println("Selected date is displayed in the text field");
//			extentReport.logToExtentReport("Selected date is displayed in the text field");
//		} else {
//			// System.out.println("Selected date is not displayed in the text field");
...
//		elementActions.doIsDisplayed(ReschedulingSuccessfulMessage);
		...
		System.out.println(reschedulingMessage);
	...
	public void VerifyThePatientDetailsOnAppointments() throws Throwable {
		Thread.sleep(2000);
		elementActions.doClick(FirstPatient);
	...
	public void clickOnCancelButton() throws InterruptedException {
		...
		elementActions.doClick(btnCancel);
	}
