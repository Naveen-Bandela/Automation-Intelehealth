...
public class AwaitPriortyInProgress extends BasePage {
	...
	By awtvstPatient1Name = By.xpath("//td[@data-test-id='awPatient0']//span");
	...
	By vsChkupReferToAnotherDrpdwn = By.xpath("//ng-select[@data-test-id='selectRefer']");
	By vsChkupReferSpecialityDrpdwn = By.xpath("//ng-select[@data-test-id='selectReferralSpeciality']");
	...
	By vsChkupReferSpecialityDrpdwnGeneralPhysician = By.xpath("//div[@role='option']//span[text()=' General Physician ']");
	...
	By vsChkupReferFacilityDrpdwn = By.xpath("//ng-select[@data-test-id='selectReferralFacility']");
	...
	By vsChkupReferSpecialityReferto = By.xpath("//th[text()='Referral to']");
	By vsChkupReferSpecialityConfirmPopupText = By
			.xpath("//p[text()='Are you sure to re-assign this visit to another doctor?']");
	By vsChkupReferSpecialityConfirmButton = By.xpath("//button[@data-test-id='btnSubmit']");
	By vsChkupReferSpecialityCancelButton = By.xpath("//button[@data-test-id='btnCancel']");
	By vsChkupReferSpecialityCloseButton = By.xpath("//button[@data-test-id='btnClose']");
	...
	By vsChkupStartVisitNotePatientInteraction = By.xpath("//h6[text()='Patient interaction']");
	By vsChkupStartVisitNoteDiagnosis = By.xpath("//h6[text()='Diagnosis']");
	By vsChkupStartVisitNoteSelectDiagnosisTextboxArrow = By
			.xpath("(//ng-select[@data-test-id='selectDiagnosisName']//span)[1]");
	By vsChkupStartVisitNoteSelectDiagnosisTextbox = By.xpath("//ng-select[@data-test-id='selectDiagnosisName']//input");
	By vsChkupStartVisitNoteSelectDiagnosisFirstValue = By.xpath("(//div[@class='ng-option ng-star-inserted'])[1]");
	By vsChkupStartVisitNoteNote = By.xpath("//h6[text()='Note']");
	By vsChkupStartVisitNoteMedication = By.xpath("//h6[text()='Medication']");
	By vsChkupStartVisitNoteAdvice = By.xpath("//h6[text()='Advice']");
	By vsChkupStartVisitNoteTest = By.xpath("//h6[text()='Test']");
	By vsChkupStartVisitNoteReferralOut = By.xpath("//h6[text()='Referral-Out']");
	By vsChkupStartVisitNoteFollowup = By.xpath("//h6[text()='Follow-up']");
	...
	By vsChkupStartVisitNoteConnLabl = By.xpath("//label[text()='Connect with patient']");
	...
	By vsChkupStartVisitNoteRadBtnYeslabel = By.xpath("//input[@data-test-id='radioSpokenYes']/..//label[text()='Yes']");
	By vsChkupStartVisitNoteRadBtnYes = By.xpath("//input[@data-test-id='radioSpokenYes']");
	By vsChkupStartVisitNoteRadBtnNo = By.xpath("//input[@data-test-id='radioSpokenNo']");
	By vsChkupStartVisitNoteRadBtnNoLabel = By.xpath("//input[@data-test-id='radioSpokenNo']/..//label[text()='No']");
	...
	By SharePrescptnText = By.xpath("//p[text()='Are you sure you want to share this prescription?']");
	By SharePrescptnSuccessText = By
			.xpath("//p[text()='The prescription has been succsessfully sent. View prescription or go to dashboard']");
	...
	By ConstDetViewPrescptn = By.xpath("//h6[@data-test-id='etHeaderConDets']");
	...
	By DrugNameTextFieldDropdown = By.xpath("//input[@data-test-id='etDrugName']/..//button");
	...
	By NoofdaysDropdownValue = By.xpath("//*[contains(@class,'dropdown-menu')]");
	...
	By lblTest = By.xpath("//h6[text()='Test']");
	By txtTestName = By.xpath("//input[@data-test-id='etTest']");
	By txtTestNameVal1 = By.xpath("(//button[@class='dropdown-item ng-star-inserted'])[1]");
	By drpTestNames = By.xpath("//ngb-typeahead-window[@id='ngb-typeahead-4']//ngb-highlight");
	...
	By iconDelete = By.xpath("//span[@class='mat-button-wrapper']/img");
	By textTest = By.xpath("//span[contains(text(),'test')]");
	By lblMedication = By.xpath("//h6[text()='Medication']");
	By txtAdditonalInstruction = By.xpath("//textarea[@data-test-id='etAI']");
	By lblAdvice = By.xpath("//h6[text()='Advice']");
	...
	By lblselectedText = By.xpath("//div[@class='d-flex justify-content-between']//button/preceding-sibling::span");
	...
	By deleteButton = By
			.xpath("//button[@class='mat-focus-indicator mat-icon-button mat-button-base ng-star-inserted']//img");
	...
	public void verifyVisitSumReferSpecialityDrpdwn() throws InterruptedException {
		...
		extentReport.logToExtentReport("Pediatrician in Refer Specialty dropdown is not displayed as the Genaral Physician is already selected");
	}
	...
	public void verifyVisitSumReferralyAddBtn() throws InterruptedException {
		...
		elementActions.doClick(vsChkupReferSpecialityReassignButton);
	...
	public void verifyVisitSumReferralyDelBtn() throws InterruptedException {
		...
		elementActions.doClick(DeleteIcon);
...
//		}
	...
	public void verifyVisitSumPatInteractionSavefn() throws InterruptedException {
		...
		extentReport.logToExtentReport("Clicked on Start visit note button");
		Thread.sleep(8000);
		elementActions.doSelect(vsChkupStartVisitNoteRadBtnYes);
		...
		elementActions.doIsDisplayed(vsChkupStartVisitNoteDelBtn);
		extentReport.logToExtentReport("Patient interaction is saved and Delete button is displayed");
	}
...
//		elementActions.scrollToElementByText("Spoken with the patient directly?");
		elementActions.doClick(vsChkupStartVisitNoteDelBtn);
		extentReport.logToExtentReport("Clicked on Delete button");
		Thread.sleep(3000);
		elementActions.doIsDisplayed(vsChkupStartVisitNoteRadBtnYeslabel);
		extentReport.logToExtentReport("verified Patient interaction deleted successfully");
	}
...
//		elementActions.doClick(SelectDiagnosisDownArrow);
	...
	public void VerifyDeleteIconFunctionality() throws Throwable {
		...
		Thread.sleep(2000);
		elementActions.doClick(StartVisitNote);
		extentReport.logToExtentReport("Clcked on Start Visit Note Button");
		Thread.sleep(2000);
		...
		extentReport.logToExtentReport("Clicked on Delete button");
		Thread.sleep(2000);
		boolean DeleteIconNull = elementActions.doIsDisplayed2(DeleteIcon);
	...
	public void VerifyIfUserCanTypeInDrugNameTextboxAndIfNumbersOrSplCharactersAllowed()
			throws Throwable {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
	...
	public void VerifyIfUserCanTypeInStrengthAndIfCharactersOrSplCharactersAreAllowed()
			throws Throwable {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
	...
	public void VerifyUserIsAbleToEnterTextInAdditionalInstructionsTextAreaUnderMedicationSection()
			throws Throwable {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
	...
	public void VerifySaveFunctionalityForAdditionalInstructionsUnderMedicationSection()
			throws Throwable {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
		...
		extentReport.logToExtentReport("Clicked on Save button fro Additional instructions");
		elementActions.doIsDisplayed(Buffering);
		...
		if (InstructionValue.contains("Hello")) {
			...
			extentReport.logToExtentReport("Entered text is added");
		} else {
	...
	public void VerifyAdditionalInstructionswithMultipleLines(String AdditionalInstructions1, String AdditionalInstructions2) throws Throwable {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
		Thread.sleep(2000);
	...
	@Step("Verify if multiple instructions can be added under medication section")
	public void VerifyAddMultipleAdvice(String AdditionalInstructions1, String AdditionalInstructions2) throws Throwable {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
		Thread.sleep(2000);
...
//		elementActions.scrollToElementByText("Provisional");
		...
		Thread.sleep(2000);
		assertEquals(diagnosisSelectedValue,diagnosisSelected);
...
//		elementActions.doSelect(vsChkupStartVisitNoteSelectDiagnosisTextboxArrow);
	...
	public void clickOnTestName(String name) {
		...
		for (int i = 0; i < elementActions.getElements(drpTestNames).size(); i++) {
			...
			if (elementActions.getElements(drpTestNames).get(i).getText().equalsIgnoreCase(name)) {
				elementActions.getElements(drpTestNames).get(i).click();
				break;
			}
		}
	}
	...
	public void clickOnButtons(String buttonName) {
		driver.findElement(By.xpath(button.replace("${button}", buttonName))).click();
	}
	...
	public void ClickOnDeleetButton() throws InterruptedException {
		...
		elementActions.doClick(AddAdviceButton);
		Thread.sleep(4000);
		elementActions.doClick(deleteButton);
		extentReport.logToExtentReport("Clicked on delete button");
	}
...
//		extentReport.logToExtentReport("Clicked on Follow up section");
	...
	public void verifyConfBtnSharePrescription() throws InterruptedException {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
		Thread.sleep(3000);
	...
	public void verifyViewPrescptnSharePrescription() throws InterruptedException {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
		Thread.sleep(3000);
	...
	public void verifyUpdatePrescptnFnctnlty() throws InterruptedException {
		...
		elementActions.doIsDisplayed(SharePrescptnText);
		extentReport.logToExtentReport("Verified: Update Prescription button is clicked and Share Prescription popup is displayed");
	}

	@Step("Verify buttons are changed once prescription is shared to a patient on visit summary page")
	public void verifyUpdateViewPrescptnBtninVisitSumPage() throws InterruptedException {
		Thread.sleep(3000);
		elementActions.doClick(awtvstPatient1Name);
		extentReport.logToExtentReport("Clicked on Awaiting visit Patient");
		Thread.sleep(3000);
