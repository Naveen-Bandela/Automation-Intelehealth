...
public class PrescriptionPage {
	...
	By lnkPrescription = By.xpath("//a[@data-test-id='linkPrescription']");
	By completedTab = By.xpath("//a[@data-test-id='navCompleted']");
	By completedPatient = By.xpath("//td[@data-test-id='compPatient0']");
	By lblVisitSummary = By.xpath("//li[@class='breadcrumb-item ng-star-inserted']//following-sibling::li");
	By lblCompletedCount = By.xpath("//h6[@class='mb-0 ml-2']");
	By countOfRecords = By
			.xpath("//mat-paginator[@data-test-id='matPaginatorSent']//div[@class='mat-paginator-range-label']");
	By countOfRecordsInCompletedVisit = By
			.xpath("//mat-paginator[@data-test-id='matPaginatorCompleted']//div[@class='mat-paginator-range-label']");

	
			
			;
	By lblPrescriptionIcon = By.xpath("//a[@data-test-id='linkPrescription']");
	By prescriptionSentBox = By.xpath("//a[@data-test-id='navSent']");
	By lblPrescriptionCount = By.xpath("//h6[@class='mb-0 ml-2']");
