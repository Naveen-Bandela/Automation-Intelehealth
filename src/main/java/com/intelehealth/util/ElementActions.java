...
//		wait.until(ExpectedConditions.elementToBeClickable(locator)).click();
	...
	public void switchToTabByUrl(String expectedUrl) {
		...
		for (String handle : allWindowHandles) {
			...
			if (expectedUrl.equals(actualUrl)) {
				System.out.println("Switched to tab with URL: " + actualUrl);
				return;
			}
		}
	...
	public String getAttributeValue(By by, String attributeName) {
		try {
			...
			System.out.println("Error retrieving attribute value: " + e.getMessage());
			return null;
		}
	}
	...
	public Object GetCurrentTime() throws Throwable {
		...
		System.out.println("Time Difference: " + roundedHours + " hours");
	 ...
	 */
	/**
	 * Updated By @SrinivasBandi o 1st OCtober 2024
	 * @param locator
	 * @param string
	 * @return
	 */
	...
	public char doGetFirstChar(By locator) {
		...
		if (Character.isDigit(Appointment)) {
			System.out.println("No. of appointments are displayed");
		}
		if (Character.isDigit(FollwUpVisit)) {
			System.out.println("No. of follow-up visits are displayed");
		}
		return Appointment;
	}
	...
	public String doGetHighlightedInBlueColor(WebElement dateElement) {
		...
		if (backgroundColor.contains("rgba(75, 57, 183, 1)")) {
			System.out.println("Current date is highlighted with blue color.");

		} else {
			System.out.println("Current date is NOT highlighted with blue color.");
		}
	...
	public void verifyBrackets(By locator) {
		...
		try {
			...
			if (StartBracket == '(' && LastBracket == ')') {
				System.out.println("Appointment Count is enclosed with Brackets");
			}
		} catch (Exception e) {
